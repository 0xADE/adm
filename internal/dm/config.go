...
type config struct {
	...
	UserLang            string           ``
	LoggingFile         string           `config:"LOGGING_FILE" default:"/var/log/adm/[TTY_NUMBER].log"`
	XorgArgs            string           `config:"XORG_ARGS" default:""`
	XorgBin             string           `config:"XORG_BIN" default:"Xorg"`
	DynamicMotdPath     string           `config:"DYNAMIC_MOTD_PATH" default:"/etc/adm/motd-gen.sh"`
	MotdPath            string           `config:"MOTD_PATH" default:"/etc/adm/motd"`
	...
	SessionErrLogFile   string           `config:"SESSION_ERROR_LOGGING_FILE" default:"/var/log/adm/session-errors.[TTY_NUMBER].log"`
